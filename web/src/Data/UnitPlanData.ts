...
export interface Unit {
  ...
  name: string;
  subtitle?: string;
  iconType?: AllowedIconType;
  x: number;
  y: number;
  icon?: string | IconType | ComponentType<{ className?: string }>;
  labelX: number;
  labelY: number;
  points: SubPoint[];
  detailImage: string;
    ...
    units: [
      {
        ...
        name: 'Sevices (Chillers)',

        subtitle: 'Mechanical ventilation, air-handling zone & dedicated washrooms',
        iconType: 'fan',
        icon: fan,
        x: 900,
        y: 480,
...

      {
        ...
        subtitle: 'Outdoor sports and recreational arena',
        icon: GiTennisCourt,
        iconType: 'trophy',
        x: 850,
        y: 600,
    ...
    units: [
      {
        ...
        name: 'AHU Room & Washrooms (2,363 sqft)',
    ...
    units: [
      {
        ...
        name: 'AHU Room & Washrooms (1,722 sqft)',
        subtitle: 'Mechanical ventilation, air-handling zone & dedicated washrooms',
        iconType: 'fan',
        icon: fan,
        x: 900,
